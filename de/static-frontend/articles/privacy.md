...
Diese Datenschutzrichtlinie beschreibt, wie Haiku.lt Daten sammelt und verwendet.
...
- **Sprachpräferenz**: Ihre ausgewählte Schnittstellensprache
  für sofortige UI-Darstellung.

- **Benachrichtigungsschließung**: Speichert, ob Sie bestimmte
  Benachrichtigungen geschlossen haben, um sie nicht wiederholt anzuzeigen.
